...
public class ProblemDto  implements Serializable {
   ...
   * @return type
  */
  @ApiModelProperty(value = "An absolute URI that identifies the problem type.  When dereferenced, it SHOULD provide human-readable documentation for the problem type (e.g., using HTML). ")
